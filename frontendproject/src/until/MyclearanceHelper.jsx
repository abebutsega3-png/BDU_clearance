...
const myclearanceApiUrl = /\/api\/clearance$/i.test(configuredApiUrl)
  ? configuredApiUrl
  : `${configuredApiUrl.replace(/\/api$/i, '')}/api/clearance`;
...
const handleNetworkError = (error) => {
  ...
  if (error.message === 'Network Error' || !error.response) {
    throw new Error(`Network error: Unable to connect to the server at ${myclearanceApiUrl}. Please check if the server is running and your internet connection is active.`);
  }
